...
public class RobotMap {
    ...
    public static SpeedController clawLeftClaw;
    public static SpeedController clawRightClaw;
    ...
    public static void init() {
        ...
        clawLeftClaw = new VictorSP(6);
        LiveWindow.addActuator("Claw", "LeftClaw", (VictorSP) clawLeftClaw);
        clawLeftClaw.setInverted(false);
        clawRightClaw = new VictorSP(5);
        LiveWindow.addActuator("Claw", "RightClaw", (VictorSP) clawRightClaw);
        clawRightClaw.setInverted(false);
