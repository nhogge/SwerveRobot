...
public class DriveSystem extends Subsystem {
    ...
    private final LidarLitePWM lidarCrab = RobotMap.lidarCrab;
    ...
    public double getCrabDistance() {
    	double distance = lidarCrab.getDistance();
    	SmartDashboard.putNumber("CrabDistance", distance);
    	return distance;
    }
    @Override
